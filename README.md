...
const umerKhan = {
    ...
    academicMatrix: {
        ...
        diplomaScore: "AI & ML Specialization (90.33%)"
    },
    ...
    activeRndModules: [
        "Data Structures & Deep Algorithms",
    ...
    coreSyntax: ["Python 🐍", "Java ☕", "JavaScript ⚡", "HTML5 🌐", "CSS3 🎨", "SQL 🛢️"],

    motto: "CODE. SOLVE. DESIGN. AUTOMATE. INNOVATE. ⚡"
};
```
...
<table border="0" width="100%">
  <tr>
    <td width="50%" valign="top">
      ...
      <ul>
        <li>🧩 <b>Daily LeetCode Grinding</b>: Solving complex DSA & optimization problems.</li>
        <li>🤖 <b>Deep Learning & Neural Nets</b>: Model training, evaluation & fine-tuning.</li>
        <li>🧬 <b>Generative AI & RAG</b>: Building intelligent LLM pipelines with LangChain & FAISS.</li>
      </ul>
    </td>
    <td width="50%" valign="top">
...
<p>
  ...
  <img src="https://img.shields.io/badge/GenAI-RAG_Systems-00ff88?style=for-the-badge&logoColor=black" />
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <ul>
        ...
        <li>🕹️ <b>Google Arcade Cloud Challenge</b></li>
    ...
    <td width="50%" valign="top">
      ...
      <ul>
        <li>📄 <b>Published Research Paper</b> in <i>IJRAR Journal</i></li>
